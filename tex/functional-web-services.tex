...
\begin{frame}
  \frametitle{RaceRegistrationService}
  \only<1>{
  \begin{center}
    \includegraphics[width=0.8\textwidth]{../pics/cassandra.png}
  \end{center}
  }
  \only<2>{
  \begin{center}
    \includegraphics[width=0.8\textwidth]{../pics/memory.png}
  \end{center}
  }
  \only<3>{
  \begin{center}
    \includegraphics[width=0.8\textwidth]{../pics/rest.png}
  \end{center}
  }
\end{frame}
